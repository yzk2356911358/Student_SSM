	...
	<div class="layui-content">
		...
		<div class="layui-row">
			<div class="layui-card positionbox">
				...
				<form class="layui-form" action="./up" method="post"
					enctype="multipart/form-data">
						<input  type="hidden" name="id"
								autocomplete="off" class="layui-input" value="${student.id }">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input style="width: 300px;" type="text" name="classs"
								autocomplete="off" class="layui-input" value="${student.classs }">
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input style="width: 300px;" type="text" name="gender"
								autocomplete="off" class="layui-input" value="${student.gender }">
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						<div class="layui-input-block">
							<button type="submit" class="layui-btn layui-btn-normal">修改学生</button>
						</div>
					</div>
				</form>
			</div>
